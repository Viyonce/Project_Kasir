...
<body>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{ $item->Stok }}</td>
      <td>
         <a href="{{url('editproduk/'.$item->ProdukID)}}" class="btn btn-primary"><i class="fa fa-edit "></i> Edit</a>
         <a href="{{url('hapusproduk/'.$item->ProdukID)}}" class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</a>
      </td>
    </tr>
     @endforeach
  </tbody>
