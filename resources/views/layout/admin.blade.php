 ...
 <table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{ $item->Password }}</td>
      <td>
         <a href="{{url('editadmin/'.$item->AdminID)}}" class="btn btn-primary"><i class="fa fa-edit "></i> Edit</a>
         <a href="{{url('hapusadmin/'.$item->AdminID)}}" class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</a>
      </td>
    </tr>
     @endforeach
  </tbody>
